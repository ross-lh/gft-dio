...
function getHeroWeapon(heroType) {
    if (heroType === "mago"){
        return "magia";
...
let tanjiroKamado = new heroClass("Tanjiro Kamado",18,"guerreiro")
let heroWeapon = getHeroWeapon(tanjiroKamado.heroType)

tanjiroKamado.attack()
